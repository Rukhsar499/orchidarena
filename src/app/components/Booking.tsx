  ...
  <div className="w-full lg:w-1/2 bg-white p-6">
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <input
        ...
        className="border-b border-gray-400 p-3 w-full transition-colors duration-300 focus:border-black focus:outline-none mb-4"
        required
      />
      ...
      <select
        ...
        onChange={handleChange}
        className="border-b border-gray-400 p-3 w-full bg-transparent transition-colors duration-300 focus:border-black focus:outline-none mb-4"
        required
      >
        <option value="" disabled>
          Select Location
